...
const Home = () => {
  ...
  return (
    <>
      <div className="bg-hero-pattern bg-no-repeat bg-cover bg-center w-full relative h-screen after:absolute after:w-full after:h-full after:bg-opBlue">
        <main className="absolute text-white z-[2] h-full w-full flex lg:flex-row flex-col items-center lg:justify-around justify-center lg:gap-0 gap-40 lg:text-start text-center">
          <section>
            <h1 className="text-[50px]">Enjoy your cho-cho pizza</h1>
            <button
      ...
      <div className="flex justify-center">
        <div className="grid xl:grid-cols-4 sm:grid-cols-2 grid-cols-1 my-20 gap-10">
          <section className="card delay-100">
          ...
          <section className="card delay-200">
            <div className="cardImage">
              <TbToolsKitchen />
            </div>
          ...
          <section className="card delay-[400]">
            <div className="cardImage">
